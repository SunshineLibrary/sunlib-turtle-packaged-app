...
public class ClientResource extends Resource {
     ...
     * {@link #setNext(Uniform)} method is called as well with a {@link org.restlet.Client}
     ...
     * {@link #handle(org.restlet.Request, Response, java.util.List, int, Uniform)} method invoked.
     * 
     * @param request
     *            The request to send.
     * @param response
     ...
     * @see org.restlet.Request#setCookies(Series)
     */
     ...
     *            origin server.
     * @see org.restlet.Request#setProxyChallengeResponse(org.restlet.data.ChallengeResponse)
     */
