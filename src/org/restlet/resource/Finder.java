 ...
 * {@link ServerResource#init(org.restlet.Context, org.restlet.Request, Response)} method.<br>
 * <br>
...
public class Finder extends Restlet {
     ...
     * {@link #create(Class, org.restlet.Request, Response)} with the "targetClass" property
     * as a parameter.
     * 
     * @param request
     *            The request to handle.
     ...
     * behavior is to invoke the {@link #create(org.restlet.Request, Response)} method.
     * 
     * @param request
     *            The request to handle.
     * @param response
