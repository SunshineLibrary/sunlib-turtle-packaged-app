...
public class Redirector extends Restlet {
    ...
    /**
     * In this mode, the call is sent to {@link org.restlet.Application#getOutboundRoot()}
     * or if null to {@link org.restlet.Context#getClientDispatcher()}. Once the selected
     ...
     * {@link org.restlet.Component} and to declare them in the list of required connectors
     * on the {@link org.restlet.Application#getConnectorService()} property.<br>
     * <br>
    ...
    /**
     * In this mode, the call is sent to {@link org.restlet.Context#getServerDispatcher()}.
