...
public abstract class Restlet implements Uniform {
     ...
     * none is define, the {@link org.restlet.Application#createFinder(Class)} method is
     ...
     * property is leveraged by {@link org.restlet.Application#setOutboundRoot(Class)} and
     * {@link org.restlet.Application#setInboundRoot(Class)} methods.
     * 
    ...
    /**
     * Handles a call. Creates an empty {@link org.restlet.Response} object and then invokes
     * {@link #handle(org.restlet.Request, org.restlet.Response)}.
     * 
     * @param request
     ...
     * {@link org.restlet.Application#setOutboundRoot(Class)} and
     * {@link org.restlet.Application#setInboundRoot(Class)} methods.
     * 
     * @param finderClass
